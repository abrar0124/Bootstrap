...
const Gallery = () => {
  ...
  // useEffect(() => {
  //   filteredHotels();
  // }, [searchQuery, selectedDate, selectedStars, selectedPrice]); // ✅ Ensure correct dependencies

  // const filteredHotels = (hotel) => {
  // const matchesCountry =
  //   selectedCountry == null || hotel.Country === selectedCountry;
  // setSelectedCountry(matchesCountry);
  // };
  // const filteredHotels = hotelsData.filter((hotel) => {
  //   const matchesCountry =
  //     selectedCountry == null || hotel.Country === selectedCountry;
